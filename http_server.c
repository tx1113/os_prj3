...
int main(int argc,char *argv[])
{
    ...
    threadpool = pool_create(QUEUESIZE,THREADCOUNT);
    ...
    while(1)
    {
      //  connfd = accept(listenfd, (struct sockaddr*)NULL, NULL);
        ...
        *(connfd_ptr)= accept(listenfd, (struct sockaddr*)NULL, NULL);
        // single threaded
 //       handle_connection(&connfd);
        pool_add_task(threadpool, handle_connection, (void*)connfd_ptr);
    }
}
